...
#        self.inKickingState = False
        ...
        #All that good stuff...
        BPConstants.setDropInRoleConstants(self, self.role)
        ...
        self.claimTracker = [0] * NogginConstants.NUM_PLAYERS_PER_TEAM
        self.claimTimer = [-1] * NogginConstants.NUM_PLAYERS_PER_TEAM
        self.roleTracker = [0] * NogginConstants.NUM_PLAYERS_PER_TEAM
        self.openDropInRole = 0
