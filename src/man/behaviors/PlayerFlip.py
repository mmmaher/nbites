...
GOALIE_FLIP_VISION_BOUNDARY = MIDFIELD_X / 2 + MIDFIELD_X / 8
GOALIE_MUTUAL_FLIP_BOUNDARY = 3 * (MIDFIELD_X / 4)
DEFENDER_FLIP_VISION_BOUNDARY = GOALIE_MUTUAL_FLIP_BOUNDARY
DEFENDER_FLIP_LOC_BOUNDARY = GOALIE_FLIP_VISION_BOUNDARY
