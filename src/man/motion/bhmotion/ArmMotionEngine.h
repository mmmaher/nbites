...
{
public:
  void update(ArmMotionEngineOutputBH& armMotionEngineOutput);
...
private:
  ...
  {
  public:
    ArmMotionRequestBH::Arm id;  /**< ID of the motion this arm currently executes */
    int firstJoint;            /**< Index of the first joint belonging to this arm within the JointDataBH's angle array */
     ...
     */
    void startMotion(ArmMotion motion, bool fast, bool autoReverse, int autoReverseTime, const FilteredJointDataBH& currentJoints)
    {
      stateIndex = 0;
      interpolationTime = 1;
      targetTime = 0;
   ...
   */
  void updateArm(Arm& arm, ArmMotionEngineOutputBH& armMotionEngineOutput);
   ...
   */
  void updateOutput(Arm& arm, ArmMotionEngineOutputBH& armMotionEngineOutput, ArmMotion::ArmAngles& values);
