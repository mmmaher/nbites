// ONLY IN OLD BHUMAN CODE

// /**
// * @file CameraSettingsBH.cpp
// * Implementation of class CameraSettingsBH.
// *
// * @author Felix Wenk
// */
...
// bool CameraSettingsBH::operator==(const CameraSettingsBH& o) const
// {
...
// std::list<CameraSettingsBH::V4L2Setting> CameraSettingsBH::getChangesAndAssign(const CameraSettingsBH& other)
// {
...
// std::list<CameraSettingsBH::V4L2Setting> CameraSettingsBH::getSettings() const
// {
...
// void CameraSettingsBH::setSetting(const V4L2Setting& setting)
// {
