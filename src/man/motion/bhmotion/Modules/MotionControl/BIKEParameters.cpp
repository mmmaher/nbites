...
// Vector3BH<> BIKEParameters::getPositionBlame(const float& phase, const int& phaseNumber, const int& limb)
// {
//   Vector3BH<> p0, p1;
//   if(phaseNumber == 0)
//   {
...
// Vector2BH<>BIKEParameters::getComRefPositionBlame(const float& phase, const int& phaseNumber)
// {
//   Vector2BH<> p0, p1;
//   if(phaseNumber == 0)
//   {
...
// Vector2BH<>BIKEParameters::getHeadRefPositionBlame(const float& phase, const int& phaseNumber)
// {
//   Vector2BH<> p0, p1;
//   if(phaseNumber == 0)
//   {
...
// void BIKEParameters::initFirstPhase(Vector3BH<> *origins, Vector2BH<> head)
// {
