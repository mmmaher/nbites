...
{,
  ...
  USES(MotionInfoBH), // NEW TO BH WALK
...
{
private:
  ENUM(EngineState, decideAction, startUp, breakUp, recover, pickUp, schwalbe);
  ...
  MotionInfoBH lastMotionInfo; //saves the last MotionInfo
