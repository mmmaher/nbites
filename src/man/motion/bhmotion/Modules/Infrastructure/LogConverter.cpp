...
// {
//   SensorDataBH* sensorData = new SensorDataBH;
...
//     memcpy(&sensorData->data[SensorDataBH::angleX], &sensorDataRev5703.data[SensorDataRev5703::angleX],
//            sizeof(float) * (SensorDataBH::numOfSensors - SensorDataBH::angleX));
...
//     sensorData->usActuatorMode = (SensorDataBH::UsActuatorMode) sensorDataRev5703.usSensorType;
...
//     sensorData->data[SensorDataBH::usR] = sensorData_2d284.data[SensorData_2d284::usR];
//     sensorData->data[SensorDataBH::angleX] = sensorData_2d284.data[SensorData_2d284::angleX];
//     sensorData->data[SensorDataBH::angleY] = sensorData_2d284.data[SensorData_2d284::angleY];

//     for(int i = SensorDataBH::usL1; i < SensorDataBH::usLEnd; ++i)
//       sensorData->data[i] = 2550.f;
//     for(int i = SensorDataBH::usR1; i < SensorDataBH::usREnd; ++i)
//       sensorData->data[i] = 2550.f;

//     sensorData->timeStamp = sensorData_2d284.timeStamp;
//     sensorData->usActuatorMode = (SensorDataBH::UsActuatorMode) sensorData_2d284.usActuatorMode;
...
//   FrameInfoBH* frameInfo = new FrameInfoBH;
...
//   JointDataBH* jointData = new JointDataBH;
//   message.bin >> jointData_d198df791237;
//   message.resetReadPosition();

//   memcpy(jointData->angles, jointData_d198df791237.angles, sizeof(float) * JointDataBH::numOfJoints);
...
//   out << CameraInfoBH::lower << 320 << 240 << 0.78674f << 0.60349f << 160.f << 120.f;

//   CameraInfoBH* cameraInfo = new CameraInfoBH;
