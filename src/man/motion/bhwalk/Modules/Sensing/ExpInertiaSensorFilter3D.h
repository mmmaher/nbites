...
//   void processUpdate(const RotationMatrixBH* rotationOffset, const Vector3f& noiseSqr);
...
//   static float getRotationZ(const RotationMatrixBH& rot3d);
//   static RotationMatrixBH getRotationW(const RotationMatrixBH& rot);
// };
