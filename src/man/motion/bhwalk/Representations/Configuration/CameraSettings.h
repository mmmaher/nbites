...
//   bool operator==(const CameraSettingsBH& o) const;
//   bool operator!=(const CameraSettingsBH& o) const {return !(*this == o);}
//   std::list<V4L2Setting> getChangesAndAssign(const CameraSettingsBH& other);
...
// CameraSettingsBH::V4L2Setting::V4L2Setting(int command, int value)
// : command(command),
//   value(value) {}
