/**
* @file ImageCoordinateSystemBH.cpp
...
ImageCoordinateSystemBH::~ImageCoordinateSystemBH()
{
  if(xTable)
  {
    delete[] xTable;
...
void ImageCoordinateSystemBH::setCameraInfo(const CameraInfoBH& cameraInfo)
{
