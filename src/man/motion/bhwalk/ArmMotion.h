...
public:
  ...
  {
    ASSERT(id != ArmMotionRequestBH::useDefault); // useDefault motion not reversible

    ArmMotion result;
    result.id = ArmMotionRequestBH::useDefault;
  ...
  (ArmMotionRequestBH, ArmMotionId) id, /** Unique id of this motion. */
