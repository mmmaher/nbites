...
{,
    ...
    {,
        ...
        (Vector2BH<>) standArmJointAngles, /**< The joint angles of the left arm when standing */
        ...
        (Vector2BH<>) walkRef, /**< The position of the pendulum pivot point in Q */
        (Vector2BH<>) walkRefAtFullSpeedX, /**< The position of the pendulum pivot point when walking forwards with maximum speed */
        (RangeBH<>) walkRefXPlanningLimit, /**< The limit for shifting the pendulum pivot point towards the x-axis when planning the next step size */
        (RangeBH<>) walkRefXLimit, /**< The limit for shifting the pendulum pivot point towards the x-axis when balancing */
        (RangeBH<>) walkRefYLimit, /**< The limit for shifting the pendulum pivot point towards the y-axis when balancing */
        (RangeBH<>) walkStepSizeXPlanningLimit, /**< The minimum and maximum step size used to plan the next step size */
        (RangeBH<>) walkStepSizeXLimit, /**< The minimum and maximum step size when balancing */
        ...
        (Vector2BH<>) walkHeight, /**< the height of the 3d linear inverted pendulum plane (for the pendulum motion towards the x-axis and the pendulum motion towards the y-axis) */
        ...
        // Diff for NAOQI_2
        (Vector3BH<>) walkLiftOffset, /**< The height the swinging foot is lifted */
        (Vector3BH<>) walkLiftOffsetAtFullSpeedX, /**< The height the swinging foot is lifted when walking full speed in x-direction */

        (Vector3BH<>) walkLiftOffsetAtFullSpeedY, /**< The height the swinging foot is lifted when walking full speed in y-direction */
        (Vector3BH<>) walkLiftRotation, /**< The amount the swinging foot is rotated while getting lifted */
        (float) walkSupportRotation, /**< A rotation added to the supporting foot to boost the com acceleration */
        (Vector3BH<>) walkComLiftOffset, /**< The height the center of mass is lifted within a single support phase */

        // Diff for NAOQI_2
        (float) walkComBodyRotation, /**< How much the torso is rotated to achieve the center of mass shift along the y-axis */

        (Pose2DBH) speedMax, /**< The maximum walking speed (in "size of two steps") */
        (float) speedMaxBackwards, /**< The maximum walking speed for backwards walking (in "size of two steps") */
        (Pose2DBH) speedMaxChange, /**< The maximum walking speed deceleration that is used to avoid overshooting of the walking target */

        (bool) balance, /**< Whether sensory feedback should be used or not */
        // (Vector2BH<>) balanceBodyRotation, //OLD BHUMAN WALK ONLY
        (Vector2BH<>) balanceCom, /**< A measured center of mass position adoption factor */
        (Vector2BH<>) balanceComVelocity, /**< A measured center of mass velocity adoption factor */
        (Vector2BH<>) balanceRef, /**< A pendulum pivot point p-control factor */
        (Vector2BH<>) balanceNextRef, /**< A pendulum pivot point of the upcoming single support phase p-control factor */
        (Vector2BH<>) balanceStepSize, /**< A step size i-control factor */
        ...
        (Pose2DBH) odometryScale, /**< A scaling factor for computed odometry data */
        ...
        // (float) minRotationToReduceStepSize, //OLD BHUMAN WALK ONLY
    }),
});


    //////////////////////////////////////////////////////////////////////////////////
        // OLD BHUMAN WALK PARAMS
